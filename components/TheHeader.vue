<template>
  <div
    class="w-[100vw] h-16 bg-gradient-to-l from-primary dark:from-primary-dark to-secondary dark:to-secondary-dark py-4 px-6 flex justify-between items-center fixed z-20"
  >
    <NuxtLink
