<template>
  <div
    class="w-96 h-[660px] bg-background border-background dark:bg-background-dark shadow-xl border-2 dark:border-primary-dark rounded-xl p-4"
  >
    <div>
...
const fetchCurrentRanking = async () => {
  ...
  const { data } = await useFetch(`/api/goal/hourly`);
